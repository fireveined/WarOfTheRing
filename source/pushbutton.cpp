...
RPGButton::RPGButton(clan::GUIManager &manager, clan::ResourceManager &application_resources) : 
	clan::Window(&manager, clan::GUITopLevelDescription("RPGButton", clan::Rect(256 + 16, 256 + 16, clan::Size(256, 180)), false))
{
	func_close().set(this, &RPGButton::on_close);
